 ...
 *
 * HOW TO ADD A PIECE:
 * 1. Place stills in  /public/nfts/velozart/images/  (e.g. VeLozArt-005.png)
 * 2. Append an object to `velozartCatalog` below
 * 3. Gallery sorts by id number (newest first) automatically
 *
...
const velozartCatalog: NftItem[] = [
  {
    ...
    image: "/nfts/velozart/images/VeLozArt-001.png",
    description:
    ...
    series: "VeLozArt",
    rarity: "mythic",
    // Objkt collection (shown as “Objkt” in the modal)
    objkt:
  ...
  },
  {
    id: "VeLozArt-002",
    title: "Biopunk Faces",
    image: "/nfts/velozart/images/VeLozArt-002.png",
    description:
  ...
  },
  {
    id: "VeLozArt-003",
    title: "Ballet Dancer",
    image: "/nfts/velozart/images/VeLozArt-003.png",
    description:
  ...
  },
  {
    ...
    image: "/nfts/velozart/images/VeLozArt-004.png",
    description:
